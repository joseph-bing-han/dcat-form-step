    ...
    $.extend(SmartWizard.prototype, {
      ...
      _setToolbar: function () {
        ...
        switch (this.options.toolbarSettings.toolbarPosition) {
          case 'top':
            toolbarTop = $('<div></div>').addClass('btn-toolbar sw-toolbar sw-toolbar-top text-right justify-content-' + this.options.toolbarSettings.toolbarButtonPosition);
            ...
            break;
          case 'bottom':
            toolbarBottom = $('<div></div>').addClass('btn-toolbar sw-toolbar sw-toolbar-bottom text-right justify-content-' + this.options.toolbarSettings.toolbarButtonPosition);
